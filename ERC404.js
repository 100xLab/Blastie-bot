function get404ContractSource(userId, name, symbol, supply, BaseURI) {
    ...
    const uniqueContractName = `ERC404Token${userId}`;
    const strSupply = supply.toString();
    const strBaseURI = BaseURI.toString();
    ...
    */
    ...
    contract ${uniqueContractName} is ERC404, Pausable, ReentrancyGuard {
        ...
        uint256 internal constant _initialSupply = ${strSupply}; // Example initial supply
        uint8 internal constant _decimal = 18; // Assuming 18 decimals
        uint256 internal constant _buylimit = 0; // Example buy limit
        uint256 internal constant _selllimit = 0; // Example sell limit
    
        constructor() ERC404("${name}", "${symbol}", _decimal, _initialSupply, msg.sender) {
            _owner = msg.sender;
            ...
            baseTokenURI = "${strBaseURI}";
        }
    
        function setLimit(uint256 _buy, uint256 _sell) public onlyOwner{
            buyLimit = _buy;
            sellLimit = _sell;
        }
